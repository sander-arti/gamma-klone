...
export function OverflowWarning({
  ...
  return (
    <div className={`bg-red-50 border border-red-200 rounded-lg p-3 ${className}`} role="alert">
        ...
        <div className="flex-1 min-w-0">
          ...
          {violations.length > 1 && (
            <ul className="mt-2 text-xs text-red-600 list-disc list-inside">
              ...
              {violations.length > 3 && <li>... og {violations.length - 3} til</li>}
            </ul>
          )}
          ...
          {showHelp && helpText && (
            <div className="mt-3 p-3 bg-red-100 rounded border border-red-200">
              ...
              {helpText.suggestions.length > 0 && (
                <>
                  <h6 className="text-xs font-semibold text-red-900 mb-1">Hva kan du gjøre?</h6>
            ...
            <div className="mt-3 flex items-center gap-2">
              {onShorten && (
                <Button
                  ...
                  onClick={onShorten}
                  disabled={isLoading}
                  className={suggestedAction === "shorten" ? "ring-2 ring-red-300" : ""}
                >
                  {isLoading ? (
              ...
              {onSplit && (
                <Button
                  ...
                  onClick={onSplit}
                  disabled={isLoading}
                  className={suggestedAction === "split" ? "ring-2 ring-red-300" : ""}
                >
                  {isLoading ? (
                    <span className="flex items-center gap-1">
