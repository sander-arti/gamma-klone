  ...
  return (
    <div
      ...
      style={{
        ...
        minHeight: scale === 1 ? "clamp(100px, 10cqw, 140px)" : `calc(clamp(100px, 10cqw, 140px) * ${scale})`,
      }}
    >
      ...
      <div
        style={{
          ...
          fontWeight: "var(--theme-typography-display-weight, 800)" as React.CSSProperties['fontWeight'],
      ...
      {sublabel && (
        <div
          style={{
            ...
            fontWeight: "var(--theme-typography-caption-weight, 500)" as React.CSSProperties['fontWeight'],
